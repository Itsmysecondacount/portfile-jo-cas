	...
	return (
		<>
			...
			<div className="small-information-about">
				...
				<p>
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum repudiandae
					qui, doloremque veniam eius optio molestiae eos magnam officia, atque nulla
					illum nam odit praesentium magni aperiam obcaecati eveniet distinctio.
				</p>
			</div>
		</>
	);
